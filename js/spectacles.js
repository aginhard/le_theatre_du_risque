...
/* Fonction de changement de media__wrapper */

$('#button-video-lmdb').click(function(){
    $('#photos-lmdb').addClass('hidden');
    $('#video-lmdb').removeClass('hidden');
    $("#player-lmdb").vimeo("play");
});
$('#button-photos-lmdb').click(function(){ 
    $('#video-lmdb').addClass('hidden');
    $('#photos-lmdb').removeClass('hidden');
    $("#player-lmdb").vimeo("pause");  
});